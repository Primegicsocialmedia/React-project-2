...
const Navbar = () => {
  ...
  return (
    <div className="px-4 sm:px-6 lg:px-8 mx-auto max-w-[1500px] h-[8vh]">
      ...
      <div className="text-white text-xl sm:text-2xl"><a href="#" className="font-bold"><span>John Doe</span></a></div> 
        ...
        <ul className="text-gray-700 font-medium hidden lg:flex lg:items-center lg:justify-center lg:space-x-10 text-2xl">
            ...
            <li className="p-2"><NavLink to="/" activeClassname="text-black">Services</NavLink></li>
      ...
      <div className={nav ? "z-30 text-gray-300 fixed h-[50%] left-0 top-0 w-full bg-[#202121] ease-in-out" : "fixed left-[-100%]"}>
